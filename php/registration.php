...
$email_subject = "Registration Form submitted";
...
if(isset($_POST['email']))
{
    ...
    $collegename = $_POST['collegename']; // required
    $degree = $_POST['degree']; // required
    $passyrs = $_POST['passyrs']; // required
    ...
    $email_message .= "College name: ".clean_string($collegename)."\n";
    $email_message .= "Qualification: ".clean_string($degree)."\n";
    $email_message .= "Passing Year: ".clean_string($passyrs)."\n";
